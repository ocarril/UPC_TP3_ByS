...
namespace ByS.Trazabilidad.Data
{
    ...
    partial void OnCreated();
		...
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), p_codigoProcedimiento, p_version, p_fechIniVigencia, p_fechFinVigencia, p_responsable, p_unidadPlazo, p_observaciones, p_actividadProcedimiento, p_plazoActividad);
			return ((int)(result.ReturnValue));
		}
