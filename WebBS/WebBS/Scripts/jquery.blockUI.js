...
"use strict";
	...
	function setup($) {
		...
		$.blockUI.defaults = {
			...
			//message:  'Procesando...',
            message: $('<div><table border="0" cellpadding="5" cellspacing="0" align="center" width="105px"><tr><td><img alt="loading" src="../Content/Images/img_ajax.gif" /></td><td style="font-size: 11px; width: 80px; height: 30px;">Procesando...</td></tr></table></div>'),
